...
SELECT CM_CONTENT, CM_DATE, USER_NICKNAME, USER_IMG  --, CM_RESP_NO 
		FROM "COMMENT"
...
SELECT CM_CONTENT, CM_DATE, USER_NICKNAME, USER_IMG, CM_NO --CM_RESP_NO 
		FROM "COMMENT"
		JOIN "USER" USING(USER_NO)
--		JOIN "COMMENT_RESP" USING(CM_NO)
		WHERE PT_NO = 2
...
SELECT PT_TITLE, PT_CONTENT, PT_DATE, PT_VIEW_COUNT, PT_VICT, PT_IMG, USER_NICKNAME, USER_IMG
		FROM "PETITION"
		JOIN "USER" USING(USER_NO)
		WHERE PT_NO = 4;
